...
OIII_A = {'amp':300, 'width':10,    'compAmps':[],'dlam':-2.348}

OIII_B = {'amp':160, 'width':'fixed','compAmps':'fixed','dlam':'fixed'}
OIII_C = {'amp':91, 'width':'fixed','compAmps':'fixed','dlam':'fixed'}
OIII_D = {'amp':37, 'width':'fixed','compAmps':'fixed','dlam':'fixed'}

startHBetaAmp = 1.42
HBetaLineInits= {'amp':[0,10000,0.001],'width':[1,600,0.01],'compAmps':[-10,10,0.0001],'dlam':[-40,40,0.01]}

HBeta_A = {'amp':1000, 'width':30,'compAmps':[],'dlam':-20}
HBeta_B = {'amp':545, 'width':'fixed','compAmps':'fixed','dlam':'fixed'}
HBeta_C = {'amp':530, 'width':'fixed','compAmps':'fixed','dlam':'fixed'}
HBeta_D = {'amp':300, 'width':'fixed','compAmps':'fixed','dlam':'fixed'}
...
continuumA = {'amp':16,'slope':startContinuumSlope}
continuumB = {'amp':9.5,'slope':2.5e-05}
continuumC = {'amp':5,'slope':2.6e-05}
continuumD = {'amp':2,'slope':2.11e-05}
...
ofiName = 'specPosteriors/ABCD_HB0_OIII0_1'
