...
FeA = {'amp': 50, 'velocity':startFeVelocity,'G':0.88,'IZw1':0.64,'S':2.57,'dlam':25.6}
FeB = {'amp': 50, 'velocity':'fixed','G':'fixed','IZw1':'fixed','S':'fixed','dlam':'fixed'}
FeC = {'amp': 50, 'velocity':'fixed','G':'fixed','IZw1':'fixed','S':'fixed','dlam':'fixed'}
...
ofiName = 'specPosteriors/ABCD_HB0_DHBW_Fe_OIII0_1'
