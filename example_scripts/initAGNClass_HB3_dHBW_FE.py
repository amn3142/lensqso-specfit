...
OIII_A = {'amp':234, 'width':7.7,    'compAmps':[],'dlam':-3.3}

OIII_B = {'amp':189, 'width':'fixed','compAmps':'fixed','dlam':'fixed'}
OIII_C = {'amp':67, 'width':'fixed','compAmps':'fixed','dlam':'fixed'}
OIII_D = {'amp':38, 'width':'fixed','compAmps':'fixed','dlam':'fixed'}

startHBetaAmp = 1.42
HBetaLineInits= {'amp':[0,10000,0.001],'width':[1,600,0.1],'compAmps':[-10,10,0.0001],'dlam':[-40,40,0.01]}

HBeta_A = {'amp':1075, 'width':32.3,'compAmps':[1,0,0],'dlam':-14}
HBeta_B = {'amp':784, 'width':32,'compAmps':'fixed','dlam':'fixed'}
HBeta_C = {'amp':299, 'width':31,'compAmps':'fixed','dlam':'fixed'}
HBeta_D = {'amp':192, 'width':34,'compAmps':'fixed','dlam':'fixed'}
...
FeA = {'amp': 16, 'velocity':startFeVelocity,'G':0.03,'IZw1':0.003,'S':9.98,'dlam':8.57}
FeB = {'amp': 9.4, 'velocity':'fixed','G':'fixed','IZw1':'fixed','S':'fixed','dlam':'fixed'}
FeC = {'amp': 4.1, 'velocity':'fixed','G':'fixed','IZw1':'fixed','S':'fixed','dlam':'fixed'}
FeD = {'amp': 50, 'velocity':'fixed','G':'fixed','IZw1':'fixed','S':'fixed','dlam':'fixed'}
...
#zero = 5012
continuumInits = {'amp':[0,100,0.01],'slope':[-0.1,0.1,1e-06]}

continuumA = {'amp':13.57,'slope':0.0049}
continuumB = {'amp':9.5,'slope':0.003}
continuumC = {'amp':4.1,'slope':0.001}
continuumD = {'amp':3.2,'slope':0.0006}
...
ofiName = 'specPosteriors/ABCD_HB3_DHBW_Fe_OIII0_1'
