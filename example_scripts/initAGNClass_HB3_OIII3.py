...
OIII_A = {'amp':10.6, 'width':6.1,    'compAmps':[-1.6,-0.4,0.4],'dlam':-2.348}
...
HBeta_A = {'amp':startHBetaAmp, 'width':34.7,'compAmps':[1,0,0],'dlam':-2.2}
...
ofiName = 'specPosteriors/ABCD_HB3_DHBW_OIII3_HBNInd_1'
