...
OIII_A = {'amp':437, 'width':12,    'compAmps':[],'dlam':-2.75}

OIII_B = {'amp':314, 'width':'fixed','compAmps':'fixed','dlam':'fixed'}
OIII_C = {'amp':117, 'width':'fixed','compAmps':'fixed','dlam':'fixed'}
OIII_D = {'amp':72, 'width':'fixed','compAmps':'fixed','dlam':'fixed'}

startHBetaAmp = 1.42
HBetaLineInits= {'amp':[0,10000,0.001],'width':[1,600,0.01],'compAmps':[-10,10,0.0001],'dlam':[-40,40,0.01]}

HBeta_A = {'amp':1172, 'width':34,'compAmps':[],'dlam':-22}
HBeta_B = {'amp':833, 'width':34,'compAmps':'fixed','dlam':'fixed'}
HBeta_C = {'amp':322, 'width':34,'compAmps':'fixed','dlam':'fixed'}
HBeta_D = {'amp':202, 'width':34,'compAmps':'fixed','dlam':'fixed'}
...
continuumA = {'amp':17.12,'slope':-0.0058}
continuumB = {'amp':11.45,'slope':-0.00272}
continuumC = {'amp':5,'slope':-0.0012}
continuumD = {'amp':3.8,'slope':-0.001}
...
ofiName = 'specPosteriors/ABCD_HB0_DHBW_OIII0_1'
